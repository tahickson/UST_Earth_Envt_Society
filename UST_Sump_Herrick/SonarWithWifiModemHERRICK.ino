...
const char* sketchName = "SonarWithWifiModemHERRICK.ino";
// Logger ID, also becomes the prefix for the name of the data file on SD card
const char* LoggerID = "HERRICK_Basement_Sonar";
...
const char *sonarDistanceMMWVarUUID = "22ba9331-852a-44bc-accc-520de29f88f3";  //Herrick Sump Distance UUID
...
const char *sonarGageHeightVarUUID = "770b6722-bdb9-4b1d-b39d-14151f08ce19"; // Herrick Sump gage height UUID
...
// The (optional) universallly unique identifier
const char *sonarVolumeUUID = "f20da89e-0d5f-4eb6-8266-a1c1410b406f";  //Herrick Sump Volume UUID
...
const char* registrationToken =
    "de007a56-0126-49a6-819a-0216378d5341";  // Device registration token for Herrick Sump
const char* samplingFeature =
    "cce77f12-dc71-4342-8f5d-262505ac9522";  // Sampling feature UUID for Herrick Sump
