 ...
 * ======================================================================= */
// THIS CODE IS CURRENTLY WORKING ON THE MAYFLY V. 1.1
// ==========================================================================
...
const char* sketchName = "SonarWithWifiModemLIBRARY.ino";
// Logger ID, also becomes the prefix for the name of the data file on SD card
const char* LoggerID = "LIBRARY_Basement_Sonar";
...
// Mayfly 0.x D31 = A7    IS THIS CAUSING PROBLEM IN THE USE OF V. 1.1??
...
// NOTE:  Use -1 for pins that do not apply
// The pin numbers here are for a Digi XBee direcly connected to a Mayfly v1.1
// I CHANGED THE Vcc PIN TO 18 HERE FROM -1 (FOR v.0.5b MCU)
...
//CHANGED ResetPin HERE FOR V.1.1 BOARD FROM v.0.5b board
...
const char*    mcuBoardVersion = "v1.1";  //Only sensor using new v 1.1 Mayfly board
