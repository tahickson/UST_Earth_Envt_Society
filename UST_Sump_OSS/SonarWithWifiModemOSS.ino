/** =========================================================================
 * @file SonarWithWifiModemOSS.ino
...
const char* sketchName = "SonarWithWifiModemOSS.ino";
// Logger ID, also becomes the prefix for the name of the data file on SD card
const char* LoggerID = "OSS_Basement_Sonar";
...
const char *sonarDistanceMMWVarUUID = "09a7d5ee-6817-4360-aa68-69a067503aa4"; //OSS Sump Distance UUID
...
float calculateSonarGageHeight(void) {
    ...
    float maximumRange = 5000;    // in millimeters. Should be determined after running sensor for a while
...
const char *sonarGageHeightVarUUID = "44b5ace2-f4c4-4fcf-999b-99f2186982e2"; //OSS Sump gage height UUID
...
// The (optional) universallly unique identifier
const char *sonarVolumeUUID = "b9eb1bba-6f56-4ad1-b30a-e288e784364f";  //OSS Sump Volume UUID
...
const char* registrationToken =
    "65dfee15-3526-4447-9b55-47065e3f379d";  // Device registration token for OSS Basement
const char* samplingFeature =
    "a6cbc264-1b8c-4c01-bf1d-6b8721ecad38";  // Sampling feature UUID for OSS Basement
